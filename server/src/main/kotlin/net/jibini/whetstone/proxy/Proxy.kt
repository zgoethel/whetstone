...
object Proxy
{
    ...
    fun <T : Any> create(baseClass: KClass<T>, baseProvider: () -> T) = java.lang.reflect.Proxy.newProxyInstance(
    ...
    inline fun <reified T : Any> create(noinline baseProvider: () -> T): T = create(T::class, baseProvider) as T
